...
<template>
    ...
    >
        ...
        >
            ...
            >
                ...
                <div>
                    <div class="flex items-baseline gap-3">
                        ...
                        >
                            ...
                            <!-- Bottom -->
                            <div
                                class="absolute my-2 flex flex-col gap-2 opacity-20"
                            >
                                <p>Coder</p>
                                <p>Art</p>
                                <div class="flex flex-col gap-2 opacity-50">
                ...
                <div class="max-w-full pb-16 min-[360px]:w-72 sm:w-80">
                    <h1
                        class="text-pixl text-center text-2xl sm:text-3xl md:text-left"
                    >
        ...
        <footer class="relative pb-3 md:fixed md:inset-x-0 md:bottom-0">
            <div
                class="text-pixl flex flex-col items-center gap-1.5 p-4 text-center"
            >
